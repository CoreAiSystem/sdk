...
> Python client SDK for interacting with the core inference API - part of the [CoreAiSystem](https://github.com/CoreAiSystem) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with CoreAiSystem's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/CoreAiSystem/sdk
cd sdk
pip install -e .
```
